...
; animation,effect,power,type,accuracy,PP
    ...
    db PIN_MISSILE  , TWO_TO_FIVE_ATTACKS_EFFECT ,  25 , BUG      , 242 , 11 ; pp 20 ; 1 ; Acr 216 -> 242 ; Pwr 14 -> 25 ; Special ; Ene 10 -> 11
    ...
    db RAZOR_LEAF   , NO_ADDITIONAL_EFFECT       ,  55 , GRASS    , 242 , 09 ; pp 25 ; 0 ; Ene 08 -> 09
    ...
    db FIRE_SPIN    , TRAPPING_EFFECT            ,  10 , FIRE     , 153 , 16 ; pp 15 ; 1 ; Pwr 15 -> 10 ; Acr 178 -> 153 ; Ene 14 -> 16
    ...
    db CONFUSE_RAY  , CONFUSION_EFFECT           ,   0 , GHOST    , 255 , 14 ; pp 15 ; - ; PP 10 -> 15
    ...
    db CLAMP        , TRAPPING_EFFECT            ,  10 , IVORY    , 140 , 14 ; pp 15 ; 0 ; Pwr 35 -> 10 ; Acr 191 -> 140 ; Type Water -> Ivory ; PP 10 -> 15
    db SWIFT        , SWIFT_EFFECT               ,  60 , NORMAL   , 255 , 10 ; pp 20 ; 1
    db SKULL_BASH   , CHARGE_EFFECT              , 130 , NORMAL   , 255 , 20 ; pp 10 ; 0 ; Pwr 100 -> 130 ; PP 15 -> 10
    db SPIKE_CANNON , TWO_TO_FIVE_ATTACKS_EFFECT ,  25 , IVORY    , 255 , 11 ; pp 20 ; 0 ; Type Normal -> Ivory ; Pwr 20 -> 25 ; PP 15 -> 20 ; Ene 10 -> 11
    ...
    db DIZZY_PUNCH  , NO_ADDITIONAL_EFFECT       ,  90 , IVORY    , 255 , 18 ; pp 10 ; 0 ; Type Normal -> Ivory ; Pwr 70 -> 90 ; Ene 20 -> 18
