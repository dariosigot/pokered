...
; animation,effect,power,type,accuracy,PP
    ...
    db POUND        , NO_ADDITIONAL_EFFECT       ,  40 , NORMAL   , 255 , 06 ; pp 35 ; 0
    db KARATE_CHOP  , NO_ADDITIONAL_EFFECT       ,  50 , FIGHTING , 255 , 08 ; pp 25 ; 0 ; Type Normal -> Fighting
    db DOUBLESLAP   , TWO_TO_FIVE_ATTACKS_EFFECT ,  15 , NORMAL   , 216 , 20 ; pp 10 ; 0
    ...
    db HORN_ATTACK  , NO_ADDITIONAL_EFFECT       ,  65 , NORMAL   , 255 , 08 ; pp 25 ; 0
    db FURY_ATTACK  , TWO_TO_FIVE_ATTACKS_EFFECT ,  15 , NORMAL   , 216 , 10 ; pp 20 ; 0
    db HORN_DRILL   , OHKO_EFFECT                ,   1 , NORMAL   ,  76 , 40 ; pp  5 ; -
    db TACKLE       , NO_ADDITIONAL_EFFECT       ,  35 , NORMAL   , 255 , 06 ; pp 35 ; 0 ; Acr 242 -> 255
    db BODY_SLAM    , PARALYZE_SIDE_EFFECT2      ,  85 , NORMAL   , 255 , 14 ; pp 15 ; 0
    ...
    db PIN_MISSILE  , TWO_TO_FIVE_ATTACKS_EFFECT ,  25 , BUG      , 242 , 10 ; pp 20 ; 0 ; Acr 216 -> 242 ; Pwr 14 -> 25
    ...
    db SOLARBEAM    , CHARGE_EFFECT              , 120 , GRASS    , 255 , 20 ; pp 10 ; 1
    ...
    db HARDEN       , DEFENSE_UP1_EFFECT         ,   0 , ROCK     , 255 , 07 ; pp 30 ; - ; Type Normal -> Rock
    db MINIMIZE     , EVASION_UP1_EFFECT         ,   0 , NORMAL   , 255 , 40 ; pp  5 ; - ; PP 20 -> 5
    ...
    db WITHDRAW     , DEFENSE_UP1_EFFECT         ,   0 , WATER    , 255 , 07 ; pp 30 ; - ; PP 40 -> 30
    db DEFENSE_CURL , DEFENSE_UP1_EFFECT         ,   0 , NORMAL   , 255 , 07 ; pp 30 ; - ; PP 40 -> 30
    ...
    db SLUDGE       , POISON_SIDE_EFFECT2        ,  65 , POISON   , 255 , 10 ; pp 20 ; 1
    db BONE_CLUB    , FLINCH_SIDE_EFFECT1        ,  65 , GROUND   , 216 , 10 ; pp 20 ; 0
    ...
    db BONEMERANG   , ATTACK_TWICE_EFFECT        ,  50 , GROUND   , 229 , 20 ; pp 10 ; 0
    ...
    db SHARPEN      , ATTACK_UP1_EFFECT          ,   0 , NORMAL   , 255 , 07 ; pp 30 ; -
