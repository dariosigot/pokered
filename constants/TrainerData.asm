...
; Cerulean City
    db $FF,18,PIDGEOTTO,15,ABRA,17,RATTATA,15,SQUIRTLE,0
    db $FF,18,PIDGEOTTO,15,ABRA,17,RATTATA,15,BULBASAUR,0
...
; Victory Road 3F
    ...
    db $FF,44,ALAKAZAM,43,TAUROS,45,KINGLER,44,KABUTOPS,45,HITMONLEE,45,GYARADOS,0
; Victory Road 1F
